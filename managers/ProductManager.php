...
class ProductManager extends AbstractManager
{
    ...
    {
        $query = $this->db
            ->prepare('SELECT product.id, product.name ,product.description ,product.prix,product.stock,category.name as category
    ...
    public function createProduct(array $post): ?int
    {
        ...
        $query = $this->db->prepare(
            "INSERT INTO product (id, name, description, prix, stock, category_id) VALUES (NULL, :name,:description,:prix,:stock,:category_id)"
        );
    ...
    public function deleteProductById($id)
    {
        ...
        $query = $this->db->prepare(
            "DELETE FROM images WHERE product_id=:value"
        );
        $parameters = [
            "value" => $id,
        ];
        ...
        $query = $this->db->prepare(
            "DELETE FROM product_has_material WHERE product_id=:value"
        );
        $parameters = [
            "value" => $id,
        ];
